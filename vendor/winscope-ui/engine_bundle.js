...
function requirePerfetto_version () {
	...
	perfetto_version.VERSION = "v49.0-94a71474c";
	perfetto_version.SCM_REVISION = "94a71474cc396db2b0fcff6755b8f2d3f7e304d0";
...
function requireTrace_processor () {
	...
	(function (module, exports) {
		...
		Module["_setThrew"] = createExportWrapper("setThrew", asm);
		...
		Module["dynCall_vij"] = createExportWrapper("dynCall_vij", asm);

		Module["dynCall_iijiii"] = createExportWrapper("dynCall_iijiii", asm);

		Module["dynCall_iiijiii"] = createExportWrapper("dynCall_iiijiii", asm);

		Module["dynCall_iijiiii"] = createExportWrapper("dynCall_iijiiii", asm);

		Module["dynCall_iiiji"] = createExportWrapper("dynCall_iiiji", asm);
